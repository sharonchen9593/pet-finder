...
//create local strategy. check if need emailField
var localLogin = new LocalStrategy({emailField: 'email'}, function(email, password, done) {
  ...
  User.findOne({email}, function(err, user) {
    ...
    // call done with email if correct email and pw
